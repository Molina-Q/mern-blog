	...
	return (
		<div className="max-w-lg mx-auto p-3 w-full">
			...
			<form className="flex flex-col gap-4">
				...
				/>
				<div
					className="size-32 self-center cursor-pointer shadow-md rounded-full relative"
				...
				>
					...
					<img
						...
						alt="user avatar"
						className={`rounded-full size-full object-cover border-8 border-[lightgray] ${imageFileUploadingProgress && imageFileUploadingProgress < 100 && 'opacity-60'}`}
					/>
				</div>
